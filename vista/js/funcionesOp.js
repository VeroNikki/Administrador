...
$scope.getProfesores= function(){
  $http.get("http://localhost:8080/PATMALUMNOS/rest/wsprofesores/listaprofesores/43f74bc1e0d8867ef14fe6841c9a9a93")
...
$scope.putProfesores= function(){
  ...
  .then(function(response) {
    ...
    $scope.postProfesores= function(){
      ...
      $http.post("http://localhost:8080/PATMALUMNOS/rest/wsprofesores/insertarprofesores/43f74bc1e0d8867ef14fe6841c9a9a93",data,headers)
      .then(function(response) {
