...
<div class="form-group" id="form1">
    <h3 id="sesion">Calificación</h3>
        ...
        <div class="row">
            ...
            <div class="col-lg-2"> 
                  <input type="button" value="Insert" ng-click="postCalificacion()" /> <br/><br/>
            </div>
            <div class="col-lg-2">
                  <input type="button" value="show" ng-click="getCalificacion()" /> <br/><br/>
            </div>
            <div class="col-lg-2">
                  <input type="button" value="Update" ng-click="putCalificacion()" /> <br/><br/>
            </div>
            <div class="col-lg-2">
                  <input type="button" value="Delete" ng-click="deleteCalificacion()" /> <br/><br/>
            </div>
            <div class="col-lg-2">
            </div>
            </div>
    ...
    <div class="row"> 
        <div class="col-md-12">
          <div ng-app="myApp" ng-controller="myCtrl">
              <hr>
              <table>
              <tr ng-repeat="x in calificacion">
