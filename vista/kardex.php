...
<html lang="en">
  <head>
    ...
    <script src="./js/funcionesKardex.js"></script>
...
<div class="form-group" id="form1">
    <h3 id="sesion">Inicia Sesión</h3>
        ...
        <div class="row">
            ...
            <div class="col-lg-2"> 
                  <input type="button" value="Insert" ng-click="postKardex()" /> <br/><br/>
            </div>
            <div class="col-lg-2">
                  <input type="button" value="show" ng-click="getKardex()" /> <br/><br/>
            </div>
            <div class="col-lg-2">
                  <input type="button" value="Update" ng-click="putKardex()" /> <br/><br/>
            </div>
            <div class="col-lg-2">
                  <input type="button" value="Delete" ng-click="deleteKardex()" /> <br/><br/>
